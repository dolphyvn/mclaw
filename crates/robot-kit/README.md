...
# Copy config
mkdir -p ~/.zeroclaw
cp crates/robot-kit/robot.toml ~/.mclaw/
cp crates/robot-kit/SOUL.md ~/.mclaw/workspace/

# Edit for your hardware
nano ~/.mclaw/robot.toml
```
...
cp ~/.mclaw/models/ggml-base.bin zeroclaw-robot-kit/models/
