//! Flash MClaw Arduino firmware via arduino-cli.
//!
...
/// MClaw Arduino Uno base firmware (capabilities, gpio_read, gpio_write).
...
/// Flash MClaw firmware to Arduino at the given port.
pub fn flash_arduino_firmware(port: &str) -> Result<()> {
    ...
    // Compile
    println!("Compiling MClaw Arduino firmware...");
    ...
    println!("MClaw firmware flashed successfully.");
