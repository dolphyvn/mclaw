//! Flash MClaw Nucleo-F401RE firmware via probe-rs.
//!
...
/// Flash MClaw Nucleo firmware. Builds from firmware/nucleo.
pub fn flash_nucleo_firmware() -> Result<()> {
    ...
    println!("Building MClaw Nucleo firmware...");
    ...
    println!("MClaw Nucleo firmware flashed successfully.");
